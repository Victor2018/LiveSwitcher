...
import com.quick.liveswitcher.utils.SharedPreferencesUtils.TAG
...
object SharedPreferencesUtils {
     ...
     */
    var preferences: SharedPreferences = PreferenceManager.getDefaultSharedPreferences(BaseApp.instance)

    /**
     * 定义 Stirng 类型的 HOST 通过 SharedPreferenceDelegates.string 将其委托给 string 方法返回的
     * ReadWriteProperty 对象
     */
    var sceneData by SharedPreferenceDelegates.string(
        ""
    )
